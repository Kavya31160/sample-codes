...
//	
	...
	public ResponseEntity<?> deleteuser(@PathVariable("passid") String passengerid) throws IdNotFoundException
	{
	...
	public ResponseEntity<?> viewbycost(@PathVariable("price") String pricevar)
	{
		...
		return new ResponseEntity<List>(passengers,HttpStatus.FOUND);
	}
